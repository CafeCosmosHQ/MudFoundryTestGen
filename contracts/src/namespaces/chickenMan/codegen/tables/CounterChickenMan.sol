...
library CounterChickenMan {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "chickenMan", name: "CounterChickenMa", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636869636b656e4d616e00000000436f756e746572436869636b656e4d61);
